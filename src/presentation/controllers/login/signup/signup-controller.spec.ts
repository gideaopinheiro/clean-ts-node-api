import { MissingParamError, ServerError, EmailAlreadyInUseError } from '@/presentation/errors'
import { EmailValidator, AccountModel, AddAccount, AddAccountParams, Validation } from './signup-controller-protocols'
