...
import { AddAccount, Authentication, AuthenticationParams, AddAccountParams } from '@/domain/usecases/account'
...
import { EmailValidator, Validation, HttpRequest } from '@/presentation/protocols'
